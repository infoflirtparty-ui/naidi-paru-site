...
const BOT_URL = process.env.NEXT_PUBLIC_BOT_URL || 'https://t.me/naidiparu_bot';

export default function MainLanding() {
  return (
    <div style={{ background: '#0C0C1D', color: 'white', minHeight: '100vh' }}>
      <div style={{
        position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0,
        backgroundImage: 'radial-gradient(ellipse at 15% 15%, rgba(255,77,141,0.08) 0%, transparent 50%), radial-gradient(ellipse at 85% 85%, rgba(168,85,247,0.07) 0%, transparent 50%)',
      }} />
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 800, margin: '0 auto', padding: '0 20px' }}>
        ...
        {/* HERO */}
        <section className="fade-in" style={{ padding: '60px 0 40px', textAlign: 'center' }}>
          <div style={{ display: 'inline-block', padding: '6px 14px', background: 'rgba(255,77,141,0.1)', border: '1px solid rgba(255,77,141,0.2)', borderRadius: 20, fontSize: 12, color: '#FF4D8D', marginBottom: 24, fontWeight: 600, letterSpacing: '0.05em' }}>🔥 ЗАКРЫТАЯ ПЛАТФОРМА</div>
          <h1 style={{ fontSize: 'clamp(36px, 8vw, 56px)', fontWeight: 800, lineHeight: 1.1, marginBottom: 20, letterSpacing: '-0.02em' }}>
          ...
          <p style={{ fontSize: 17, color: '#A0A0C0', lineHeight: 1.5, maxWidth: 560, margin: '0 auto 12px' }}>
            Закрытая платформа знакомств для мужчин
          </p>
          <p style={{ fontSize: 15, color: '#6B6B8D', lineHeight: 1.6, maxWidth: 560, margin: '0 auto 40px' }}>
            Без мусора. Без игр. Без женщин, ищущих кошелёк.<br/>
            Только отобранные девушки, которые хотят отношений и семью.
          </p>
          <a href={BOT_URL} target="_blank" rel="noopener noreferrer"
            className="btn-primary"
            style={{ display: 'inline-block', padding: '18px 40px', background: 'linear-gradient(135deg, #FF4D8D, #A855F7)', color: 'white', fontSize: 16, fontWeight: 700, borderRadius: 16, textDecoration: 'none', boxShadow: '0 10px 40px rgba(255,77,141,0.35)', letterSpacing: '0.02em' }}>
            Начать подбор →
          </a>
        </section>
        ...
        <section style={{ padding: '40px 0' }}>
          ...
          <Card>
            ...
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                'ценят своё время',
                'не хотят тратить месяцы на переписки',
                'устали от меркантильности и фальши',
                'ищут нормальную, адекватную девушку для отношений',
              ].map(t => (
        ...
        <section style={{ padding: '40px 0' }}>
          ...
          <Card>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                'Только реальные девушки',
                'Без замужних и скрытых историй',
                'Без девушек, которые ищут только деньги',
                'Без случайных анкет и «инстаграмных продаж»',
              ].map(t => (
        ...
        <section style={{ padding: '40px 0' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              <Card key={s.n} padding={18}>
                <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                  <div style={{ width: 44, height: 44, borderRadius: 14, background: 'linear-gradient(135deg, #FF4D8D, #A855F7)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 700, flexShrink: 0 }}>{s.n}</div>
                  <div>
        ...
        <section style={{ padding: '40px 0' }}>
          ...
          <div style={{ padding: 2, borderRadius: 24, background: 'linear-gradient(135deg, rgba(255,77,141,0.4), rgba(168,85,247,0.4))' }}>
            <div style={{ background: 'linear-gradient(145deg, #161630, #1A1A3E)', borderRadius: 22, padding: 28, textAlign: 'center' }}>
              <div style={{ fontSize: 'clamp(36px, 8vw, 52px)', fontWeight: 800, letterSpacing: '-1px', marginBottom: 4, background: 'linear-gradient(135deg, #FF4D8D, #A855F7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>10 000 <span style={{ fontSize: 20, opacity: 0.7, color: 'white', background: 'none', WebkitTextFillColor: 'white' }}>₸</span></div>
              <p style={{ fontSize: 14, color: '#A0A0C0', marginBottom: 24 }}>30 анкет девушек</p>
        ...
        {/* IMPORTANT */}
        <section style={{ padding: '40px 0' }}>
          <Card style={{ background: 'linear-gradient(145deg, rgba(251,191,36,0.05), rgba(251,191,36,0.02))', borderColor: 'rgba(251,191,36,0.2)' }}>
        ...
        <section style={{ padding: '60px 0 40px', textAlign: 'center' }}>
          <div style={{ display: 'inline-block', padding: '6px 14px', background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: 20, fontSize: 12, color: '#4ADE80', marginBottom: 20, fontWeight: 600 }}>✅ ГОТОВ?</div>
          <h2 style={{ fontSize: 'clamp(26px, 6vw, 38px)', fontWeight: 800, lineHeight: 1.15, marginBottom: 20, letterSpacing: '-0.02em' }}>Если ты хочешь:</h2>
          ...
          <a href={BOT_URL} target="_blank" rel="noopener noreferrer"
            className="btn-primary"
            style={{ display: 'inline-block', padding: '18px 48px', background: 'linear-gradient(135deg, #FF4D8D, #A855F7)', color: 'white', fontSize: 16, fontWeight: 700, borderRadius: 16, textDecoration: 'none', boxShadow: '0 10px 40px rgba(255,77,141,0.35)' }}>
            👉 Заполнить анкету
          </a>
          <p style={{ marginTop: 32, fontSize: 14, color: '#6B6B8D', maxWidth: 440, margin: '32px auto 0', lineHeight: 1.6, fontStyle: 'italic' }}>
...
function SectionTitle({ icon, label }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
      ...
      <h2 style={{ fontSize: 14, fontWeight: 700, color: '#6B6B8D', textTransform: 'uppercase', letterSpacing: '0.1em' }}>{label}</h2>
    </div>
  );
}
