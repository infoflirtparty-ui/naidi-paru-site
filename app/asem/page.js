          ...
          <section style={{ padding: '30px 0' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                { n: '04', title: 'Миллион ухажёров', desc: 'Ты научишься цеплять с первых секунд, вызывать интерес, удерживать внимание. Мужчины будут дарить подарки и исполнять твои желания.' },
                ...
                { n: '06', title: 'Вход в отношения', desc: 'Ты научишься сразу видеть, кто серьёзный, а кто нет. Уже с первых свиданий. Перестанешь тратить месяцы на изучение мужчины.' },
              ].map((m, i) => (
